...
const slug = 'lash-lift-tint';
const service = services.find((item) => item.slug === slug)!;

export const metadata: Metadata = {
  title: 'Lash Lift Twin Falls | Lash Lift + Tint',
  description: 'Book a lash lift Twin Falls clients love for low-maintenance curl, darker-looking lashes, aftercare guidance, FAQs, and luxury beauty care.',
};
