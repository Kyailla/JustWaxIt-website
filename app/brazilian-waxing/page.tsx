...
export const metadata: Metadata = {
  title: 'Brazilian Wax Twin Falls Idaho | Private Luxury Waxing',
  description: 'Book a Brazilian wax in Twin Falls, Idaho with JustWaxIt. Private, professional hard wax service with prep tips, aftercare, FAQs, and easy booking.',
};
